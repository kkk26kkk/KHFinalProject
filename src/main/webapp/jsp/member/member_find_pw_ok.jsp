...
<!-- 메인 헤더 끝 -->
	...
	<div id="member_find">
		<form action="member_find_pw_form_ok.nf" method="post">
			<div id="a0">
				<div>
					<h3>임시 비밀번호 변경</h3><hr>
				</div>
				<div style="padding-bottom: 30px;">
					<strong>임시 비밀번호를 변경하시겠습니까?</strong>
					<input type="hidden" name="id" value="${id}"><br>
				</div>
				<div>
					<input type="submit" class="btn-primary" value="지금 변경하기">
					<input type="reset" id="a" class="btn-danger" value="다음에 변경하기"
